//! Lyrics for the playing track, from LRCLIB.
//!
...
//! song instead of guessing. Spotify's own lyrics need the streaming session
//! and a Premium plan; this works for whatever is playing, wherever.
//!
